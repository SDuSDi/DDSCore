...
static const _AuxGlobalPosition_type_support_symbol_names_t _AuxGlobalPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, core_msgs, msg, AuxGlobalPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, core_msgs, msg, AuxGlobalPosition)),
  }
};
