...
#ifndef CORE_MSGS__MSG__DETAIL__AUX_GLOBAL_POSITION__FUNCTIONS_H_
#define CORE_MSGS__MSG__DETAIL__AUX_GLOBAL_POSITION__FUNCTIONS_H_
 ...
 * calls
 * core_msgs__msg__AuxGlobalPosition__init().
...
/**
 * It calls
 * core_msgs__msg__AuxGlobalPosition__fini()
 ...
 * core_msgs__msg__AuxGlobalPosition__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * core_msgs__msg__AuxGlobalPosition__Sequence__fini()
 * on the array,
...
#endif  // CORE_MSGS__MSG__DETAIL__AUX_GLOBAL_POSITION__FUNCTIONS_H_
