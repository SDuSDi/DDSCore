...
void core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_init_function(
...
void core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_message_members = {
  ...
  core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_message_type_support_handle = {
  0,
  &core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, core_msgs, msg, AuxGlobalPosition)() {
  if (!core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_message_type_support_handle.typesupport_identifier) {
    core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &core_msgs__msg__AuxGlobalPosition__rosidl_typesupport_introspection_c__AuxGlobalPosition_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
